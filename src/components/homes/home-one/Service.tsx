            ...
            <div className="row">
               <div className="col-lg-4">
                  <div className="section-title border-radius-5 p-35 bg-base style-white mb-lg-0">
                     <h2 className="title mt-4">{language === "ar" ? ":حول منزلك إلى ملاذ للراحة والأمان" : "Turn your home into a haven of comfort and security:"}</h2>
                     <p className="content">{language === "ar" ? "الحلول الذكية: تخيل منزلاً يلبي احتياجاتك. ضبط الأضواء والتحكم بدرجة الحرارة و ادارة الاجهزة بسهولة من خلال أنظمتنا المنزلية الذكية المتكاملة بدءًا من المساعدين الصوتيين وحتى الأجهزة المتصلة، نقوم بإنشاء نظام بيئي مخصص من الراحة" : "Smart Solutions: Imagine a home that anticipates your needs. Adjust lights, control temperature, and manage appliances with ease through our integrated smart home systems. From voice-activated assistants to connected devices, we create a personalized ecosystem of convenience."} </p>
                     <p className="content">{language === "ar" ? "الأنظمة الأمنية: راحة بالك هي أولويتنا. يوفر جوما الأمان المتقدم حلول لحماية أحبائك وممتلكاتك. اختر من بين مجموعة متنوعة من الخيارات،بما في ذلك كاميرات الدوائر التلفزيونية المغلقة مع إمكانية المشاهدة عن بعد، وأنظمة التحكم الذكية في الوصول،وأجهزة إنذار ضد السرقة متطورة. نحن نخصص كل نظام ليتناسب مع احتياجاتك الخاصة المتطلبات، وضمان الحماية المثلى." : "Security Systems: Your peace of mind is our priority. GOMA provides advanced security solutions to safeguard your loved ones and belongings. Choose from a variety of options, including CCTV cameras with remote viewing capabilities, intelligent access control systems, and sophisticated burglar alarms. We customize each system to match your specific requirements, ensuring optimal protection."}</p>
                     <div className="btn-wrap mt-4 pt-1 mb-4">
                        <Link className="it-btn btn-small btn-border-white mt-2 me-2" href="/contact">{language === "ar" ? "اتصل بنا" : "Contact Us"}</Link>
                        <Link className="it-btn btn-small btn-black mt-2" href="/service">{language === "ar" ? " كل الخدمة" : "All Service"}</Link>
                     </div>
                  </div>
               </div>
