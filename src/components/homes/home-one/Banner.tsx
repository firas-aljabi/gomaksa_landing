...
import banner_2 from "@/assets/img/banner/826.700(1).webp";
            ...
            <div className="row justify-content-center">
               ...
               <div className="col-lg-6 col-md-9 order-lg-first align-self-center">
                  <div className="banner-inner style-white  text-center text-lg-start">
                     ...
                     <h2 className="title"> Goma smart solutions is Your Gateway to a Smarter Future</h2>
                     <p className="content">Smart solutions for homes & businesses in Saudi Arabia. GOMA
                      offers custom smart home, security, AI, & app development</p>
                     <div className="btn-wrap">
                        <Link className="it-btn btn-base mr-space" href="tel:+1(570)2129021">Get Started</Link>
